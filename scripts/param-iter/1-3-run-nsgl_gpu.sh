...
DATA_DIR="./data"
RESULT_DIR="./results/param-iter/snap_tfdp_gpu"
...
echo "===== GPU Parameter Iteration Experiment ====="
echo "Thread count (NT): ${NT}"
...
for dataset in "${DATASETS[@]}"; do
  for iter in "${ITERS[@]}"; do
    for seed in {1..5}; do
      ...
      echo "===== Running dataset: ${dataset}, iter: ${iter}, seed: ${seed}, NT: ${NT} (GPU) =====" | tee "${LOG_FILE}"
