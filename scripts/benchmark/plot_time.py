...
DEFAULT_METHOD_DISPLAY_NAMES = {
    ...
    "snap_tfdp": "SNAP-tFDP ",
    "snap_tfdp_par": "SNAP-tFDP-P16",
    "snap_tfdp_gpu": "SNAP-tFDP-GPU",
}
...
COLORS = {
    ...
    "snap_tfdp": "#3b3bed",
    "snap_tfdp_par": "#ffa90a",
    "snap_tfdp_gpu": "#0a850a",
}
...
def main():
    ...
    # 图2：原始值（乘以N）
    plot_scatter(dataset_info, time_data, methods, DEFAULT_METHOD_DISPLAY_NAMES,
                 MARKERS, COLORS, normalize=False, output_path=args.output, dpi=args.dpi)
